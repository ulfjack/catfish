...
public final class StandardResponses {
  ...
  public static final HttpResponse NO_CONTENT =
      new PreconstructedResponse(HttpStatusCode.NO_CONTENT);

  // 300
  public static final HttpResponse NOT_MODIFIED =
      new PreconstructedResponse(HttpStatusCode.NOT_MODIFIED); // 304
  ...
  public static final HttpResponse PAYMENT_REQUIRED =
      new PreconstructedResponse(HttpStatusCode.PAYMENT_REQUIRED); // 402
  public static final HttpResponse FORBIDDEN =
  ...
  public static final HttpResponse PROXY_AUTH_REQUIRED =
      new PreconstructedResponse(HttpStatusCode.PROXY_AUTH_REQUIRED); // 407
  public static final HttpResponse REQUEST_TIMEOUT =
      new PreconstructedResponse(HttpStatusCode.REQUEST_TIMEOUT); // 408
  public static final HttpResponse CONFLICT =
      new PreconstructedResponse(HttpStatusCode.CONFLICT); // 409
  public static final HttpResponse GONE = new PreconstructedResponse(HttpStatusCode.GONE); // 410
  public static final HttpResponse LENGTH_REQUIRED =
      new PreconstructedResponse(HttpStatusCode.LENGTH_REQUIRED); // 411
  public static final HttpResponse PRECONDITION_FAILED =
      new PreconstructedResponse(HttpStatusCode.PRECONDITION_FAILED); // 412
  public static final HttpResponse PAYLOAD_TOO_LARGE =
