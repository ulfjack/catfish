...
public enum HttpStatusCode {
  ...
  /**
   * Return a string containing the code and the well-known status text, if defined by RFC 2616. If
   * the status text is unknown, returns informational status text as defined by the ranges in RFC
   * 2616. If the status code is outside those ranges, returns "None".
   *
