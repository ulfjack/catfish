...
public final class HttpHeaderName {
  ...
  private static final String REG_NAME =
      "(?:(?:" + UNRESERVED + "|" + SUBDELIMS + "|" + PCT_ENCODED + ")*)";
  ...
  private static final Pattern HOST_PORT_PATTERN =
      Pattern.compile("(" + HOST_PATTERN + ")(:\\d*)?");
  ...
  /**
   * Returns a canonical representation of the given HTTP header field name. If known, it returns a
   * representation with a well-known capitalization. Otherwise, it returns an all-lowercase
   * representation.
   */
