/**
 * Cut-point markers. Each call names a proof obligation site; the string is a Lean `Prop` spliced
 * into the generated obligations, elaborated in a scope where the method's locals are bound to
 * their source-level names.
 *
